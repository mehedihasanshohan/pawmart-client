...
const ListingDetails = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center text-lg text-base-100">
  ...
  return (
    <section className="py-20 bg-base-200 text-base-content  min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Main Content Card */}
        <div className="bg-base-300 p-8 rounded-md shadow-md overflow-hidden flex flex-col md:flex-row gap-4">
          {/* Image */}
          ...
          <div className="md:w-1/2 p-4 flex flex-col justify-between">
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-2 text-2xl font-bold">
                {listing.Price === 0 ? (
                  <p className="">Free for Adoption</p>
                ) : (
                  <>
              ...
              <div className="">
                ...
                <p className="leading-relaxed italic">{listing.description}</p>
              </div>

              {/* Email Contact */}
              <div className="">
                <h3 className="text-lg font-semibold mb-2">Contact Email:</h3>
                <p className="italic">{listing.email || "Not provided"}</p>
              </div>
            ...
            <button
              ...
              className="mt-6 w-full hover:bg-teal-600 bg-base-100 py-3 rounded-md font-semibold transition cursor-pointer"
            >
              Adopt / Order Now
            </button>
            ...
            <button
              ...
              className="mt-8 w-full hover:bg-teal-600 bg-base-100 cursor-pointer py-3 rounded-md font-semibold transition"
            >
              ← Back to Listings
            </button>
          </div>
          ...
          <div className="relative rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl p-6">
            ...
            <form
              onSubmit={(e) => {
                ...
                const order = {
                  ...
                  email: user.email,
                  quantity:
                    listing.category === "Pets" ? 1 : e.target.quantity.value,
                  price: listing.Price,
            ...
            >
              ...
              <div className="flex justify-between mt-6">
                <button
                  type="submit"
                  className="btn w-1/2 mr-2 cursor-pointer"
                >
                  Submit Order
                </button>
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="btn w-1/2 cursor-pointer"
                >
                  Cancel
                </button>
              </div>
