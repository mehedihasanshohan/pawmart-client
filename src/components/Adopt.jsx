...
//       img: "https://i.ibb.co/SJKmtRF/hero1.jpg",
//     },
//     {
//       id: 2,
//       name: "Nayeem Rahman",
//       role: "Adopted a senior dog",
//       img: "https://i.ibb.co/nMR9nY7/hero2.jpg",
//     },
//     {
//       id: 3,
//       name: "Tania Islam",
//       role: "Runs a pet shelter in Dhaka",
//       img: "https://i.ibb.co/tmxSnwr/hero3.jpg",
//     },
//   ];
...
//         </h2>
//         <p className=" max-w-3xl mx-auto text-gray-600 dark:text-white leading-relaxed">
...
//         <div className="flex justify-center mb-4">
//           <FaPaw className="text-teal-600 text-4xl" />
//         </div>
...
//                 {hero.name}
//               </h3>
//               <p className="text-sm text-gray-500 mt-1">{hero.role}</p>
//             </div>
//           ))}
//         </div>
//       </section>
